...
public class SearchBotMessageHandler extends BotMessageHandler {

  private static final Logger logger = LoggerFactory.getLogger(SearchBotMessageHandler.class);
  ...
  @Inject
  public SearchBotMessageHandler(final HighriseFactory highriseFactory, final UserDataService userDataService) {
