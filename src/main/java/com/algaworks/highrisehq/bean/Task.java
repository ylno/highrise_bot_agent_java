...
public class Task implements Serializable {
  ...
  public String toString() {
    return "Task{" + "id=" + id + ", body=" + body + ", ownerId=" + ownerId + ", subjectId=" + subjectId + ", subjectType=" + subjectType
        + ", categoryId=" + categoryId + ", dueAt=" + dueAt + ", _public=" + _public + ", notify=" + notify + '}';
  }
